...
const ProductDetail = () => {
  ...
  if (!product) return (
    <div className="container d-flex align-items-center justify-content-center flex-grow-1" style={{ height: "80vh" }}>
  ...
  <h2 className="fw-bold mb-4 text-center">{product.product_name}</h2>
  
  <div className="d-flex justify-content-between mt-5" style={{ minHeight: "90vh" }}>
    {/* คอลัมน์ซ้าย (รูปภาพ) */}
